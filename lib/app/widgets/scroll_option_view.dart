...
typedef OptionItemViewBuilder = Widget Function(BuildContext context, String option, int index);
typedef OptionChanged = Widget Function(BuildContext context, String option, int index);
...
class ScrollOptionView extends StatefulWidget {
  ...
  ScrollOptionView({Key key, @required this.options, this.itemBuilder, this.activeItemBuilder, this.onOptionChanged, this.activeIndex = 0})
    : assert(options != null);
